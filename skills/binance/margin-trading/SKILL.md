...
* **symbol**: Trading pair symbol or isolated margin pair (e.g., BNBUSDT)
* **recvWindow**: No more than 60000 (e.g., 5000)
* **asset**: Asset name (e.g., BTC)
* **type**: Transfer Type: ROLL_IN, ROLL_OUT or availability type: `MARGIN`, `ISOLATED`
...
* **isolatedSymbol**: Isolated margin symbol (e.g., BNBUSDT)
...
* **amount**: Borrow or repay amount. (e.g., 1.0)
...
* **pendingAboveTimeInForce**: Time in force for the pending above order. Values: GTC, IOC, FOK
...
* **pendingBelowTimeInForce**: Time in force for the pending below order. Values: GTC, IOC, FOK
* **quantity**: Order quantity. (e.g., 1.0)
* **quoteOrderQty**: Quote order quantity for market orders. (e.g., 1.0)
...
* **preventedMatchId**: Prevented match ID to query. (e.g., 1)
* **fromPreventedMatchId**: Prevented match ID to get prevented matches from INCLUSIVE. (e.g., 1)
